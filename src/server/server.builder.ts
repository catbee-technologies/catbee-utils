...
export class ServerConfigBuilder {
  private config: Partial<CatbeeServerConfig> = {};
  ...
  withRateLimit(opts: Partial<CatbeeServerConfig['rateLimit']>): this {
    this.mergeConfig('rateLimit', opts as NonNullable<CatbeeServerConfig['rateLimit']>);
    return this;
  }
  ...
  withRequestLogging(opts: Partial<NonNullable<CatbeeServerConfig['requestLogging']>>): this {
    this.mergeConfig('requestLogging', opts as NonNullable<CatbeeServerConfig['requestLogging']>);
    return this;
  }
  ...
  withOpenApi(opts: Partial<NonNullable<CatbeeServerConfig['openApi']>>): this {
    this.mergeConfig('openApi', opts as NonNullable<CatbeeServerConfig['openApi']>);
    return this;
  }
  ...
  enableOpenApi(
    filePath: string,
    opts: Omit<Partial<NonNullable<CatbeeServerConfig['openApi']>>, 'enable' | 'filePath'> = {}
  ): this {
  ...
  withMicroService(opts: {
    ...
    this.mergeConfig('serviceVersion', opts.serviceVersion as NonNullable<CatbeeServerConfig['serviceVersion']>);
    return this;
  }
  ...
  withRequestId(opts: Partial<NonNullable<CatbeeServerConfig['requestId']>>): this {
    this.mergeConfig('requestId', opts as NonNullable<CatbeeServerConfig['requestId']>);
    return this;
  }
  ...
  withResponseTime(opts: Partial<NonNullable<CatbeeServerConfig['responseTime']>>): this {
    this.mergeConfig('responseTime', opts as NonNullable<CatbeeServerConfig['responseTime']>);
    return this;
  }
  ...
  build(): Readonly<CatbeeServerConfig> {
    const config = deepObjMerge({}, getCatbeeServerGlobalConfig(), this.config) as CatbeeServerConfig;
  ...
  private mergeConfig<K extends keyof CatbeeServerConfig>(
    key: K,
  ...
  private setEnabled<K extends keyof CatbeeServerConfig>(
    key: K,
    enable: boolean,
    overrides: Partial<NonNullable<CatbeeServerConfig[K]>> = {}
  ): this {
