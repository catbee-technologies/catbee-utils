...
describe("UrlUtils", () => {
  ...
  describe("getDomain", () => {
    ...
    it("removes subdomains if flag set", () => {
      expect(getDomain("https://api.example.com/path", true)).toBe(
        "example.com",
      );
  ...
  describe("joinPaths", () => {
    it("joins URL segments with single slashes", () => {
      expect(joinPaths("https://a.com/", "/foo/", "/bar")).toBe(
        "https://a.com/foo/bar",
      );
  ...
  describe("normalizeUrl", () => {
    it("normalizes protocol, host, and path", () => {
      expect(normalizeUrl("HTTP://Example.COM/foo/../bar")).toBe(
        "http://example.com/bar",
      );
    });
    it("handles protocol-relative URLs", () => {
      expect(normalizeUrl("//example.com/test")).toBe(
